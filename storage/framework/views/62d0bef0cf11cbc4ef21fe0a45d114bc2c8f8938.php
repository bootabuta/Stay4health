                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="<?php echo e(route('tool')); ?>">Tools</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="<?php echo e(route('video')); ?>">videos</a>
                            </li>
                            <li class="nav-item ">
...
<?php /**PATH C:\xampp\htdocs\lastWeb\resources\views/layouts/app.blade.php ENDPATH**/ ?>